...
let heartRate2D: Double = 95
let heartRate3D: Double = 65
let addedHRT = heartRate1D + heartRate2D + heartRate3D
let averageHRD = addedHRT / 3
print(averageHRD)
print("This differs since we are doing decimal division now instead of integer division")
